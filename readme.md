...
如何在生成环境中使用，而在发布的时候关闭掉swagger的功能?
...
在dev环境下
    ...
    kalipy@debian ~/b/j/k/d/demo> more src/main/resources/application.properties
    spring.profiles.active=dev

![Image](./img/image_2021-03-23-18-46-19.png)
...
qq邮箱开启pop3功能(别人不需要开，我们发送者需要开)

![Image](./img/image_2021-03-23-20-16-37.png)
...
application.properties
    ...
    spring.mail.username=3069087972@qq.com
    spring.mail.password=mdnvodqbdfkidebf
